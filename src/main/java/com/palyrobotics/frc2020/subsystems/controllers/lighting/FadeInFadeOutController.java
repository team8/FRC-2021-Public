...
public class FadeInFadeOutController extends Lighting.LEDController {
	...
	public FadeInFadeOutController(int startIndex, int lastIndex, Color.HSV flashedColor, double delay, int priority) {
	...
	public FadeInFadeOutController(int startIndex, int lastIndex, Color.HSV flashedColor, double delay, double duration, int priority) {
		super(startIndex, lastIndex, priority);
		mStartIndex = startIndex;
		mLastIndex = lastIndex;
		mFlashedColor = flashedColor;
